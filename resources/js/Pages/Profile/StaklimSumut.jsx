...
import { ChevronDown, MapPin, CheckCircle, Target } from 'lucide-react';

export default function StaklimSumut() {
    return (
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute top-full left-0 mt-1 w-64 rounded-xl bg-white shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                                    <div className="p-2 flex flex-col gap-1">
                                        ...
                                        <Link href={route('profile.staklim-sumut')} className="block px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg">
